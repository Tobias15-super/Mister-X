...
const Ge = function(t) {
  ...
  encodeByteArray(t, e) {
    ...
    for (let r = 0; r < t.length; r += 3) {
      ...
      l || (I = 64, i || (m = 64)), s.push(n[d], n[h], n[m], n[I]);
    }
    return s.join("");
  },
  /**
   ...
   */
  encodeString(t, e) {
    return this.HAS_NATIVE_SUPPORT && !e ? btoa(t) : this.encodeByteArray(Ge(t), e);
  },
  /**
   ...
   */
  decodeString(t, e) {
    return this.HAS_NATIVE_SUPPORT && !e ? atob(t) : Pt(this.decodeStringToByteArray(t, e));
  },
  /**
   * Base64-decode a string.
   *
...
const xt = function(t) {
  const e = Ge(t);
  return Je.encodeByteArray(e, !0);
}, Xe = function(t) {
  return xt(t).replace(/\./g, "");
}, Ut = function(t) {
  try {
    return Je.decodeString(t, !0);
  } catch (e) {
 ...
 * limitations under the License.
 */
const Ft = () => $t().__FIREBASE_DEFAULTS__, jt = () => {
  ...
  var t;
  return (t = Kt()) == null ? void 0 : t.config;
};
/**
 * @license
 * Copyright 2017 Google LLC
...
class L extends Error {
  constructor(e, n, s) {
    super(n), this.code = e, this.customData = s, this.name = Vt, Object.setPrototypeOf(this, L.prototype), Error.captureStackTrace && Error.captureStackTrace(this, z.prototype.create);
  }
}
class z {
  constructor(e, n, s) {
  ...
  create(e, ...n) {
    const s = n[0] || {}, r = `${this.service}/${e}`, a = this.errors[e], i = a ? qt(a, s) : "Error", o = `${this.serviceName}: ${i} (${r}).`;
    return new L(r, o, s);
  }
}
function qt(t, e) {
  return t.replace(zt, (n, s) => {
    const r = e[s];
...
const Zt = {
  ...
  if (e < t.logLevel)
    return;
  const s = (/* @__PURE__ */ new Date()).toISOString(), r = tn[e];
  if (r)
...
class sn {
   ...
   */
  constructor(e) {
    this.name = e, this._logLevel = en, this._logHandler = nn, this._userLogHandler = null;
  }
  get logLevel() {
...
const rn = (t, e) => e.some((n) => t instanceof n);
let Me, Le;
function an() {
  return Me || (Me = [
    IDBDatabase,
...
const et = /* @__PURE__ */ new WeakMap(), he = /* @__PURE__ */ new WeakMap(), tt = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), ye = /* @__PURE__ */ new WeakMap();
function cn(t) {
  ...
  get(t, e, n) {
    if (t instanceof IDBTransaction) {
      ...
      if (e === "objectStoreNames")
        return t.objectStoreNames || tt.get(t);
      if (e === "store")
...
function hn(t) {
  return t === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(e, ...n) {
    ...
    return tt.set(s, e.sort ? e.sort() : [e]), y(s);
  } : on().includes(t) ? function(...e) {
    return t.apply(Z(this), e), y(et.get(this));
  } : function(...e) {
    return y(t.apply(Z(this), e));
  };
}
function fn(t) {
  return typeof t == "function" ? hn(t) : (t instanceof IDBTransaction && ln(t), rn(t, an()) ? new Proxy(t, fe) : t);
}
function y(t) {
  ...
  if (Q.has(t))
    return Q.get(t);
  const e = fn(t);
  return e !== t && (Q.set(t, e), ye.set(e, t)), e;
}
const Z = (t) => ye.get(t);
function G(t, e, { blocked: n, upgrade: s, blocking: r, terminated: a } = {}) {
  const i = indexedDB.open(t, e), o = y(i);
  return s && i.addEventListener("upgradeneeded", (l) => {
    s(y(i.result), l.oldVersion, l.newVersion, y(i.transaction), l);
...
const dn = ["get", "getKey", "getAll", "getAllKeys", "count"], pn = ["put", "add", "delete", "clear"], te = /* @__PURE__ */ new Map();
function Pe(t, e) {
  if (!(t instanceof IDBDatabase && !(e in t) && typeof e == "string"))
    return;
  if (te.get(e))
    return te.get(e);
  const n = e.replace(/FromIndex$/, ""), s = e !== n, r = pn.includes(n);
  if (
    // Bail if the target doesn't exist on the target. Eg, getAll isn't in Edge.
    !(n in (s ? IDBIndex : IDBObjectStore).prototype) || !(r || dn.includes(n))
  )
    return;
...
const de = "@firebase/app", Be = "0.14.1";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const H = /* @__PURE__ */ new Map(), Wn = /* @__PURE__ */ new Map(), ge = /* @__PURE__ */ new Map();
function xe(t, e) {
  try {
...
function nt(t, e = {}) {
  ...
  const a = H.get(r);
  if (a) {
    if (ue(n, a.options) && ue(s, a.config))
      return a;
 ...
 * limitations under the License.
 */
const Gn = "firebase-heartbeat-database", Jn = 1, $ = "firebase-heartbeat-store";
let ne = null;
function st() {
  return ne || (ne = G(Gn, Jn, {
    upgrade: (t, e) => {
      switch (e) {
        case 0:
          try {
...
async function Xn(t) {
  try {
    const n = (await st()).transaction($), s = await n.objectStore($).get(rt(t));
...
async function Ue(t, e) {
  try {
    const s = (await st()).transaction($, "readwrite");
    await s.objectStore($).put(e, rt(t)), await s.done;
  } catch (n) {
    if (n instanceof L)
      S.warn(n.message);
    else {
...
class Zn {
  constructor(e) {
    ...
    this._storage = new ts(n), this._heartbeatsCachePromise = this._storage.read().then((s) => (this._heartbeatsCache = s, s));
  }
  /**
  ...
  async triggerHeartbeat() {
    ...
    try {
      ...
      if (((e = this._heartbeatsCache) == null ? void 0 : e.heartbeats) == null && (this._heartbeatsCache = await this._heartbeatsCachePromise, ((n = this._heartbeatsCache) == null ? void 0 : n.heartbeats) == null) || this._heartbeatsCache.lastSentHeartbeatDate === a || this._heartbeatsCache.heartbeats.some((i) => i.date === a))
        return;
      if (this._heartbeatsCache.heartbeats.push({ date: a, agent: r }), this._heartbeatsCache.heartbeats.length > Qn) {
        const i = ns(this._heartbeatsCache.heartbeats);
  ...
  async getHeartbeatsHeader() {
    ...
    try {
      if (this._heartbeatsCache === null && await this._heartbeatsCachePromise, ((e = this._heartbeatsCache) == null ? void 0 : e.heartbeats) == null || this._heartbeatsCache.heartbeats.length === 0)
        return "";
      const n = $e(), { heartbeatsToSend: s, unsentEntries: r } = es(this._heartbeatsCache.heartbeats), a = Xe(JSON.stringify({ version: 2, heartbeats: s }));
...
function ss(t) {
  N(new D(
    ...
    "PRIVATE"
    /* ComponentType.PRIVATE */
  )), O(de, Be, t), O(de, Be, "esm2020"), O("fire-js", "");
}
ss("");
var rs = "firebase", as = "12.1.0";
/**
 * @license
 ...
 */
O(rs, as, "app");
const at = "@firebase/installations", Se = "0.6.19";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const it = 1e4, ot = `w:${Se}`, ct = "FIS_v2", is = "https://firebaseinstallations.googleapis.com/v1", os = 60 * 60 * 1e3, cs = "installations", ls = "Installations";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
async function ps({ appConfig: t, heartbeatServiceProvider: e }, { fid: n }) {
  const s = ut(t), r = dt(t), a = e.getImmediate({
    optional: !0
  });
  if (a) {
  ...
  if (l.ok) {
    ...
    return {
      ...
      authToken: ht(c.authToken)
    };
  } else
    throw await ft("Create Installation", l);
}
/**
 * @license
 * Copyright 2019 Google LLC
...
function ys(t, e) {
  const n = _s();
  n && n.postMessage({ key: t, fid: e }), Ss();
}
let A = null;
function _s() {
...
async function K(t, e) {
  const n = J(t), r = (await Ie()).transaction(R, "readwrite"), a = r.objectStore(R), i = await a.get(n);
  return await a.put(e, n), await r.done, (!i || i.fid !== e.fid) && wt(t, e.fid), e;
}
async function yt(t) {
  const e = J(t), s = (await Ie()).transaction(R, "readwrite");
  await s.objectStore(R).delete(e), await s.done;
}
async function X(t, e) {
  const n = J(t), r = (await Ie()).transaction(R, "readwrite"), a = r.objectStore(R), i = await a.get(n), o = e(i);
  return o === void 0 ? await a.delete(n) : await a.put(o, n), await r.done, o && (!i || i.fid !== o.fid) && wt(t, o.fid), o;
}
/**
 * @license
 * Copyright 2019 Google LLC
...
async function As(t, e) {
  try {
    ...
    throw lt(n) && n.customData.serverCode === 409 ? await yt(t.appConfig) : await K(t.appConfig, {
      fid: e.fid,
      registrationStatus: 0
      /* RequestStatus.NOT_STARTED */
    }), n;
...
async function Rs({ appConfig: t, heartbeatServiceProvider: e }, n) {
  const s = vs(t, n), r = hs(t, n), a = e.getImmediate({
    optional: !0
  });
  if (a) {
    const c = await a.getHeartbeatsHeader();
  ...
  if (l.ok) {
    ...
    throw await ft("Generate Auth Token", l);
}
function vs(t, { fid: e }) {
  return `${ut(t)}/${e}/authTokens:generate`;
}
/**
 * @license
 * Copyright 2019 Google LLC
...
async function Os(t, e) {
  ...
  for (; n.authToken.requestStatus === 1; )
    await gt(100), n = await He(t.appConfig);
  const s = n.authToken;
...
async function Ns(t, e) {
  try {
    ...
    if (lt(n) && (n.customData.serverCode === 401 || n.customData.serverCode === 404))
...
function Ls(t) {
  const e = Date.now();
  return e < t.creationTime || t.creationTime + t.expiresIn < e + os;
}
function Ps(t) {
  const e = {
    requestStatus: 1,
 ...
 * limitations under the License.
 */
async function Us(t, e = !1) {
  const n = t;
  return await $s(n), (await Ce(n, e)).token;
}
async function $s(t) {
 ...
 * limitations under the License.
 */
const It = "installations", js = "installations-internal", Hs = (t) => {
  const e = t.getProvider("app").getImmediate(), n = Fs(e), s = _e(e, "heartbeat");
  return {
    app: e,
    appConfig: n,
  ...
  const e = t.getProvider("app").getImmediate(), n = _e(e, It).getImmediate();
  return {
    getId: () => xs(n),
    getToken: (r) => Us(n, r)
  };
 ...
 * limitations under the License.
 */
const Et = "BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4", Vs = "https://fcmregistrations.googleapis.com/v1", Ct = "FCM_MSG", qs = "google.c.a.c_id", zs = 3, Gs = 1;
var W;
(function(t) {
 ...
 * limitations under the License.
 */
const ae = "fcm_token_details_db", Xs = 5, Ke = "fcm_token_object_Store";
async function Ys(t) {
  if ("databases" in indexedDB && !(await indexedDB.databases()).map((a) => a.name).includes(ae))
    return null;
  let e = null;
  return (await G(ae, Xs, {
  ...
  })).close(), await ee(ae), await ee("fcm_vapid_details_db"), await ee("undefined"), Qs(e) ? e : null;
}
function Qs(t) {
 ...
 * limitations under the License.
 */
const Zs = "firebase-messaging-database", er = 1, v = "firebase-messaging-store";
let ie = null;
function Te() {
  return ie || (ie = G(Zs, er, {
    upgrade: (t, e) => {
      switch (e) {
        case 0:
...
}, p = new z("messaging", "Messaging", nr);
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
async function rr(t, e) {
  const n = await ve(t), s = At(e.subscriptionOptions), r = {
    method: "PATCH",
    headers: n,
    body: JSON.stringify(s)
  };
...
function At({ p256dh: t, auth: e, endpoint: n, vapidKey: s }) {
  ...
  return s !== Et && (r.web.applicationPubKey = s), r;
}
/**
 * @license
 * Copyright 2019 Google LLC
 ...
 * limitations under the License.
 */
const ar = 7 * 24 * 60 * 60 * 1e3;
async function ir(t) {
  const e = await cr(t.swRegistration, t.vapidKey), n = {
    vapidKey: t.vapidKey,
    swScope: t.swRegistration.scope,
    endpoint: e.endpoint,
    auth: w(e.getKey("auth")),
    p256dh: w(e.getKey("p256dh"))
  }, s = await Ae(t.firebaseDependencies);
  if (s) {
    if (lr(s.subscriptionOptions, n))
      return Date.now() >= s.createTime + ar ? or(t, {
        token: s.token,
        createTime: Date.now(),
        subscriptionOptions: n
      }) : s.token;
    try {
      await Tt(t.firebaseDependencies, s.token);
    } catch (r) {
      console.warn(r);
    }
    return Ve(t.firebaseDependencies, n);
  } else return Ve(t.firebaseDependencies, n);
}
async function We(t) {
  const e = await Ae(t.firebaseDependencies);
  e && (await Tt(t.firebaseDependencies, e.token), await tr(t.firebaseDependencies));
  const n = await t.swRegistration.pushManager.getSubscription();
  return n ? n.unsubscribe() : !0;
}
async function or(t, e) {
  try {
    const n = await rr(t.firebaseDependencies, e), s = {
      ...e,
      token: n,
      createTime: Date.now()
    };
 ...
 */
function pr(t) {
  return typeof t == "object" && !!t && qs in t;
}
/**
 * @license
 * Copyright 2019 Google LLC
...
async function mr(t, e) {
  const n = wr(e, await t.firebaseDependencies.installations.getId());
  br(t, n, e.productId);
}
function wr(t, e) {
  var s, r;
  const n = {};
  return t.from && (n.project_number = t.from), t.fcmMessageId && (n.message_id = t.fcmMessageId), n.instance_id = e, t.notification ? n.message_type = W.DISPLAY_NOTIFICATION.toString() : n.message_type = W.DATA_MESSAGE.toString(), n.sdk_platform = zs.toString(), n.package_name = self.origin.replace(/(^\w+:|^)\/\//, ""), t.collapse_key && (n.collapse_key = t.collapse_key), n.event = Gs.toString(), (s = t.fcmOptions) != null && s.analytics_label && (n.analytics_label = (r = t.fcmOptions) == null ? void 0 : r.analytics_label), n;
}
function br(t, e, n) {
  const s = {};
  s.event_time_ms = Math.floor(Date.now()).toString(), s.source_extension_json_proto3 = JSON.stringify({
    messaging_client_event: e
  }), n && (s.compliance_data = yr(n)), t.logEvents.push(s);
}
function yr(t) {
  return {
    privacy_context: {
...
async function _r(t, e) {
  ...
  const s = await Ae(e.firebaseDependencies);
  await We(e), e.vapidKey = ((r = s == null ? void 0 : s.subscriptionOptions) == null ? void 0 : r.vapidKey) ?? Et, await ir(e);
}
async function Sr(t, e) {
  const n = Cr(t);
  if (!n)
...
async function Ir(t) {
  var i, o;
  const e = (o = (i = t.notification) == null ? void 0 : i.data) == null ? void 0 : o[Ct];
  if (e) {
    if (t.action)
      return;
  } else return;
  ...
  if (s.host !== r.host)
    return;
  let a = await Tr(s);
  if (a ? a = await a.focus() : (a = await self.clients.openWindow(n), await gr(3e3)), !!a)
    return e.messageType = V.NOTIFICATION_CLICKED, e.isFirebaseMessaging = !0, a.postMessage(e);
}
function Er(t) {
  const e = {
    ...t.notification
...
function Rr(t) {
  ...
  return e || (pr(t.data) ? self.location.origin : null);
}
/**
 * @license
 * Copyright 2019 Google LLC
 ...
 */
async function Lr() {
  return Qe() && await Ze() && "PushManager" in self && "Notification" in self && ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification") && PushSubscription.prototype.hasOwnProperty("getKey");
}
/**
 * @license
 * Copyright 2017 Google LLC
...
function Pr(t = zn()) {
  ...
  }), _e(Gt(t), "messaging-sw").getImmediate();
}
/**
 * @license
 * Copyright 2017 Google LLC
...
}, ce = (t) => [b.prefix, t, b.suffix].filter((e) => e && e.length > 0).join("-"), Ur = (t) => {
...
class Yr {
   ...
   */
  constructor(e, n) {
    this._cacheKeys = {}, Object.assign(this, n), this.event = n.event, this._strategy = e, this._handlerDeferred = new zr(), this._extendLifetimePromises = [], this._plugins = [...e.plugins], this._pluginStateMap = /* @__PURE__ */ new Map();
  ...
  async cachePut(e, n) {
    ...
    if (!a)
      return !1;
    const { cacheName: i, matchOptions: o } = this._strategy, l = await self.caches.open(i), c = this.hasCallback("cacheDidUpdate"), d = c ? await qr(
    ...
    try {
      ...
      if (h instanceof Error)
        throw h.name === "QuotaExceededError" && await Jr(), h;
    }
...
class Qr {
  ...
  handleAll(e) {
    ...
    const n = e.event, s = typeof e.request == "string" ? new Request(e.request) : e.request, r = "params" in e ? e.params : void 0, a = new Yr(this, { event: n, request: s, params: r }), i = this._getResponse(a, s, n), o = this._awaitComplete(i, a, s, n);
    return [i, o];
  }
...
class E extends Qr {
   ...
   */
  constructor(e = {}) {
    e.cacheName = Oe.getPrecacheName(e.cacheName), super(e), this._fallbackToNetwork = e.fallbackToNetwork !== !1, this.plugins.push(E.copyRedirectedCacheableResponsesPlugin);
  }
  /**
   * @private
...
E.copyRedirectedCacheableResponsesPlugin = {
  async cacheWillUpdate({ response: t }) {
    return t.redirected ? await Wr(t) : t;
  }
};
class Zr {
  /**
  ...
  addToCacheList(e) {
    ...
    for (const s of e) {
      ...
      const { cacheKey: r, url: a } = Fr(s), i = typeof s != "string" && s.revision ? "reload" : "default";
...
const Rt = "GET", q = (t) => t && typeof t == "object" ? t : { handle: t };
class U {
  /**
...
let x;
const na = () => (x || (x = new ta(), x.addFetchListener(), x.addCacheListener()), x);
function sa(t, e, n) {
  let s;
  if (typeof t == "string") {
...
function* aa(t, { ignoreURLParametersMatching: e = [/^utm_/, /^fbclid$/], directoryIndex: n = "index.html", cleanURLs: s = !0, urlManipulation: r } = {}) {
  const a = new URL(t, location.href);
  a.hash = "", yield a.href;
  const i = ra(a, e);
...
async function Ot(t, e) {
  try {
    return !self.registration || typeof self.registration.getNotifications != "function" ? !1 : await Nt(t, e);
  } catch (n) {
...
async function be(t, e) {
  ...
  try {
    const s = new AbortController(), r = setTimeout(() => s.abort(), 8e3);
...
self.addEventListener("push", (t) => {
  t.waitUntil((async () => {
    await self.registration.showNotification(title, opts), await Ot(bgTag, { tries: 10, intervalMs: 100 });
    const e = (async () => {
      const n = await we().catch(() => null);
      await be(messageId, n);
    })();
    t.waitUntil(e);
  })());
});
self.addEventListener("push", (t) => {
  t.waitUntil((async () => {
    ...
    if (d) {
      ...
      if (m) {
        const g = `${l}-fg`, Mt = {
          ...
          data: { url: i, messageId: o, tag: g, fg: !0 }
        };
        await self.registration.showNotification(r, Mt), await Nt(g, { tries: 10, intervalMs: 50 }), await new Promise((P) => setTimeout(P, 900)), (await self.registration.getNotifications({ tag: g })).forEach((P) => P.close());
        try {
          await be(o, await we());
        } catch (P) {
          M("[SW] markDelivered failed:", P);
        }
        return;
      }
      return;
    ...
    await self.registration.showNotification(r, Y), await Ot(I, { tries: 10, intervalMs: 100 });
    try {
      const g = await we();
      await be(o, g);
    } catch (g) {
      M("[SW] markDelivered failed:", g);
    }
  })());
});
...
self.addEventListener("sync", (t) => {
  t.tag === "flush-acks" && t.waitUntil(flushQueuedAcks());
});
...
self.addEventListener("pushsubscriptionchange", (t) => {
  t.waitUntil((async () => {
    try {
      ...
      try {
        await da("pushSubscriptionChangedAt", Date.now());
      } catch {
      }
    } catch (e) {
