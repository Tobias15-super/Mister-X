...
const Xe = function(t) {
  ...
  encodeByteArray(t, e) {
    ...
    for (let r = 0; r < t.length; r += 3) {
      ...
      let m = (o & 15) << 2 | c >> 6, O = c & 63;
      l || (O = 64, i || (m = 64)), s.push(n[d], n[h], n[m], n[O]);
    }
    return s.join("");
  },
  /**
   ...
   */
  decodeString(t, e) {
    return this.HAS_NATIVE_SUPPORT && !e ? atob(t) : Ut(this.decodeStringToByteArray(t, e));
  },
  /**
   * Base64-decode a string.
   *
 ...
 * limitations under the License.
 */
const Kt = () => Ht().__FIREBASE_DEFAULTS__, Wt = () => {
  ...
  var t;
  return (t = Vt()) == null ? void 0 : t.config;
};
/**
 * @license
 * Copyright 2017 Google LLC
...
class L extends Error {
  constructor(e, n, s) {
    super(n), this.code = e, this.customData = s, this.name = Gt, Object.setPrototypeOf(this, L.prototype), Error.captureStackTrace && Error.captureStackTrace(this, V.prototype.create);
  }
}
class V {
  constructor(e, n, s) {
  ...
  create(e, ...n) {
    const s = n[0] || {}, r = `${this.service}/${e}`, a = this.errors[e], i = a ? Jt(a, s) : "Error", o = `${this.serviceName}: ${i} (${r}).`;
    return new L(r, o, s);
  }
}
function Jt(t, e) {
  return t.replace(Xt, (n, s) => {
    const r = e[s];
...
const nn = {
  ...
  if (e < t.logLevel)
    return;
  const s = (/* @__PURE__ */ new Date()).toISOString(), r = rn[e];
  if (r)
...
class on {
   ...
   */
  constructor(e) {
    this.name = e, this._logLevel = sn, this._logHandler = an, this._userLogHandler = null;
  }
  get logLevel() {
  ...
  setLogLevel(e) {
    this._logLevel = typeof e == "string" ? nn[e] : e;
  }
  get logHandler() {
...
const cn = (t, e) => e.some((n) => t instanceof n);
let Me, Pe;
function ln() {
  return Me || (Me = [
    IDBDatabase,
...
function pn(t) {
  return t === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(e, ...n) {
    ...
    return st.set(s, e.sort ? e.sort() : [e]), S(s);
  } : un().includes(t) ? function(...e) {
    return t.apply(te(this), e), S(nt.get(this));
  } : function(...e) {
    return S(t.apply(te(this), e));
  };
}
function gn(t) {
  return typeof t == "function" ? pn(t) : (t instanceof IDBTransaction && fn(t), cn(t, ln()) ? new Proxy(t, pe) : t);
}
function S(t) {
...
const mn = ["get", "getKey", "getAll", "getAllKeys", "count"], wn = ["put", "add", "delete", "clear"], se = /* @__PURE__ */ new Map();
function Le(t, e) {
  if (!(t instanceof IDBDatabase && !(e in t) && typeof e == "string"))
    return;
  if (se.get(e))
    return se.get(e);
  const n = e.replace(/FromIndex$/, ""), s = e !== n, r = wn.includes(n);
  if (
    // Bail if the target doesn't exist on the target. Eg, getAll isn't in Edge.
    !(n in (s ? IDBIndex : IDBObjectStore).prototype) || !(r || mn.includes(n))
  )
    return;
 ...
 * limitations under the License.
 */
const I = new on("@firebase/app"), _n = "@firebase/app-compat", Sn = "@firebase/analytics-compat", In = "@firebase/analytics", En = "@firebase/app-check-compat", Cn = "@firebase/app-check", Tn = "@firebase/auth", kn = "@firebase/auth-compat", An = "@firebase/database", Dn = "@firebase/data-connect", Rn = "@firebase/database-compat", vn = "@firebase/functions", Nn = "@firebase/functions-compat", On = "@firebase/installations", Mn = "@firebase/installations-compat", Pn = "@firebase/messaging", Ln = "@firebase/messaging-compat", Bn = "@firebase/performance", xn = "@firebase/performance-compat", Un = "@firebase/remote-config", $n = "@firebase/remote-config-compat", Fn = "@firebase/storage", jn = "@firebase/storage-compat", Hn = "@firebase/firestore", Kn = "@firebase/ai", Wn = "@firebase/firestore-compat", qn = "firebase";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const j = /* @__PURE__ */ new Map(), zn = /* @__PURE__ */ new Map(), we = /* @__PURE__ */ new Map();
function xe(t, e) {
  try {
 ...
 * limitations under the License.
 */
const Yn = "firebase-heartbeat-database", Qn = 1, $ = "firebase-heartbeat-store";
let re = null;
function at() {
  return re || (re = z(Yn, Qn, {
    upgrade: (t, e) => {
      switch (e) {
        case 0:
          try {
...
async function Zn(t) {
  try {
    const n = (await at()).transaction($), s = await n.objectStore($).get(it(t));
...
async function Ue(t, e) {
  try {
    const s = (await at()).transaction($, "readwrite");
    await s.objectStore($).put(e, it(t)), await s.done;
  } catch (n) {
    if (n instanceof L)
      I.warn(n.message);
    else {
...
class ns {
  constructor(e) {
    ...
    this._storage = new rs(n), this._heartbeatsCachePromise = this._storage.read().then((s) => (this._heartbeatsCache = s, s));
  }
  /**
  ...
  async triggerHeartbeat() {
    ...
    try {
      ...
      if (((e = this._heartbeatsCache) == null ? void 0 : e.heartbeats) == null && (this._heartbeatsCache = await this._heartbeatsCachePromise, ((n = this._heartbeatsCache) == null ? void 0 : n.heartbeats) == null) || this._heartbeatsCache.lastSentHeartbeatDate === a || this._heartbeatsCache.heartbeats.some((i) => i.date === a))
        return;
      if (this._heartbeatsCache.heartbeats.push({ date: a, agent: r }), this._heartbeatsCache.heartbeats.length > ts) {
        const i = as(this._heartbeatsCache.heartbeats);
  ...
  async getHeartbeatsHeader() {
    ...
    try {
      if (this._heartbeatsCache === null && await this._heartbeatsCachePromise, ((e = this._heartbeatsCache) == null ? void 0 : e.heartbeats) == null || this._heartbeatsCache.heartbeats.length === 0)
        return "";
      const n = $e(), { heartbeatsToSend: s, unsentEntries: r } = ss(this._heartbeatsCache.heartbeats), a = Qe(JSON.stringify({ version: 2, heartbeats: s }));
 ...
 * limitations under the License.
 */
const ct = 1e4, lt = `w:${Se}`, ut = "FIS_v2", ls = "https://firebaseinstallations.googleapis.com/v1", us = 60 * 60 * 1e3, hs = "installations", fs = "Installations";
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
function ft({ projectId: t }) {
  return `${ls}/projects/${t}/installations`;
}
function dt(t) {
  return {
    token: t.token,
    requestStatus: 2,
    expiresIn: gs(t.expiresIn),
...
function ps(t, { refreshToken: e }) {
  const n = gt(t);
  return n.append("Authorization", ms(e)), n;
}
async function mt(t) {
  const e = await t();
 ...
 * limitations under the License.
 */
async function ws({ appConfig: t, heartbeatServiceProvider: e }, { fid: n }) {
...
function Is(t, e) {
  const n = Es();
  n && n.postMessage({ key: t, fid: e }), Cs();
}
let k = null;
function Es() {
 ...
 * limitations under the License.
 */
const Ts = "firebase-installations-database", ks = 1, R = "firebase-installations-store";
let ae = null;
function Ie() {
  return ae || (ae = z(Ts, ks, {
    upgrade: (t, e) => {
      switch (e) {
        case 0:
...
async function H(t, e) {
  const n = G(t), r = (await Ie()).transaction(R, "readwrite"), a = r.objectStore(R), i = await a.get(n);
  return await a.put(e, n), await r.done, (!i || i.fid !== e.fid) && yt(t, e.fid), e;
}
async function St(t) {
  const e = G(t), s = (await Ie()).transaction(R, "readwrite");
  await s.objectStore(R).delete(e), await s.done;
}
async function J(t, e) {
  const n = G(t), r = (await Ie()).transaction(R, "readwrite"), a = r.objectStore(R), i = await a.get(n), o = e(i);
...
async function Os({ appConfig: t, heartbeatServiceProvider: e }, n) {
  const s = Ms(t, n), r = ps(t, n), a = e.getImmediate({
    optional: !0
  });
  if (a) {
    const c = await a.getHeartbeatsHeader();
...
async function Ps(t, e) {
  let n = await He(t.appConfig);
  for (; n.authToken.requestStatus === 1; )
    await wt(100), n = await He(t.appConfig);
  const s = n.authToken;
...
function Bs(t) {
  return t.requestStatus === 2 && !xs(t);
}
function xs(t) {
  const e = Date.now();
  return e < t.creationTime || t.creationTime + t.expiresIn < e + us;
}
function Us(t) {
  const e = {
    requestStatus: 1,
 ...
 * limitations under the License.
 */
async function js(t, e = !1) {
  const n = t;
  return await Hs(n), (await Ce(n, e)).token;
}
async function Hs(t) {
 ...
 * limitations under the License.
 */
const Ct = "installations", Ws = "installations-internal", qs = (t) => {
 ...
 * limitations under the License.
 */
const Tt = "BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4", Gs = "https://fcmregistrations.googleapis.com/v1", kt = "FCM_MSG", Js = "google.c.a.c_id", Xs = 3, Ys = 1;
var K;
(function(t) {
 ...
 * limitations under the License.
 */
const oe = "fcm_token_details_db", Zs = 5, Ke = "fcm_token_object_Store";
async function er(t) {
  if ("databases" in indexedDB && !(await indexedDB.databases()).map((a) => a.name).includes(oe))
    return null;
  let e = null;
  return (await z(oe, Zs, {
  ...
  })).close(), await ne(oe), await ne("fcm_vapid_details_db"), await ne("undefined"), tr(e) ? e : null;
}
function tr(t) {
 ...
 * limitations under the License.
 */
const nr = "firebase-messaging-database", sr = 1, v = "firebase-messaging-store";
let ce = null;
function Te() {
  return ce || (ce = z(nr, sr, {
    upgrade: (t, e) => {
      switch (e) {
        case 0:
...
async function ke(t) {
  ...
  if (s)
    return s;
  {
    const r = await er(t.appConfig.senderId);
    if (r)
...
}, g = new V("messaging", "Messaging", ar);
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
function Re({ projectId: t }) {
  return `${Gs}/projects/${t}/registrations`;
}
 ...
 * limitations under the License.
 */
const cr = 7 * 24 * 60 * 60 * 1e3;
async function lr(t) {
  const e = await hr(t.swRegistration, t.vapidKey), n = {
    vapidKey: t.vapidKey,
  ...
  if (s) {
    if (fr(s.subscriptionOptions, n))
      return Date.now() >= s.createTime + cr ? ur(t, {
        token: s.token,
        createTime: Date.now(),
...
async function We(t) {
  ...
  e && (await At(t.firebaseDependencies, e.token), await rr(t.firebaseDependencies));
  const n = await t.swRegistration.pushManager.getSubscription();
  return n ? n.unsubscribe() : !0;
}
async function ur(t, e) {
  try {
    const n = await or(t.firebaseDependencies, e), s = {
      ...e,
      token: n,
      createTime: Date.now()
    };
 ...
 */
function wr(t) {
  return typeof t == "object" && !!t && Js in t;
}
/**
 * @license
 * Copyright 2019 Google LLC
...
async function Er(t, e) {
  ...
  await We(e), e.vapidKey = ((r = s == null ? void 0 : s.subscriptionOptions) == null ? void 0 : r.vapidKey) ?? Tt, await lr(e);
}
async function Cr(t, e) {
  const n = Ar(t);
  if (!n)
    return;
  e.deliveryMetricsExportedToBigQueryEnabled && await yr(e, n);
  const s = await Rt();
  if (Rr(s))
    return vr(s, n);
  if (n.notification && await Nr(kr(n)), !!e && e.onBackgroundMessageHandler) {
    const r = dr(n);
...
async function Tr(t) {
  ...
  if (s.host !== r.host)
    return;
  let a = await Dr(s);
  if (a ? a = await a.focus() : (a = await self.clients.openWindow(n), await br(3e3)), !!a)
...
function Or(t) {
  ...
  return e || (wr(t.data) ? self.location.origin : null);
}
/**
 * @license
 * Copyright 2019 Google LLC
 ...
 */
const Lr = (t) => {
  const e = new Pr(t.getProvider("app").getImmediate(), t.getProvider("installations-internal").getImmediate(), t.getProvider("analytics-internal"));
...
function Ur(t = Xn()) {
  ...
  }), _e(Yt(t), "messaging-sw").getImmediate();
}
/**
 * @license
 * Copyright 2017 Google LLC
...
const y = {
...
}, ue = (t) => [y.prefix, t, y.suffix].filter((e) => e && e.length > 0).join("-"), jr = (t) => {
  ...
  getGoogleAnalyticsName: (t) => t || ue(y.googleAnalytics),
  getPrecacheName: (t) => t || ue(y.precache),
  getPrefix: () => y.prefix,
  getRuntimeName: (t) => t || ue(y.runtime),
  getSuffix: () => y.suffix
};
function Ve(t, e) {
  const n = e();
...
function Kr(t) {
  ...
  return s.searchParams.set(Hr, e), {
    cacheKey: s.href,
    url: r.href
  };
}
...
async function zr(t, e) {
  ...
  }, i = Vr() ? s.body : await s.blob();
  return new Response(i, a);
}
const Gr = (t) => new URL(String(t), location.href).href.replace(new RegExp(`^${location.origin}`), "");
function ze(t, e) {
  const n = new URL(t);
  for (const s of e)
...
class ea {
   ...
   */
  constructor(e, n) {
    this._cacheKeys = {}, Object.assign(this, n), this.event = n.event, this._strategy = e, this._handlerDeferred = new Xr(), this._extendLifetimePromises = [], this._plugins = [...e.plugins], this._pluginStateMap = /* @__PURE__ */ new Map();
  ...
  async cachePut(e, n) {
    ...
    if (!a)
      return !1;
    const { cacheName: i, matchOptions: o } = this._strategy, l = await self.caches.open(i), c = this.hasCallback("cacheDidUpdate"), d = c ? await Jr(
    ...
    try {
      ...
      if (h instanceof Error)
        throw h.name === "QuotaExceededError" && await Qr(), h;
    }
...
class ta {
   ...
   */
  constructor(e = {}) {
    this.cacheName = Ne.getRuntimeName(e.cacheName), this.plugins = e.plugins || [], this.fetchOptions = e.fetchOptions, this.matchOptions = e.matchOptions;
  }
  /**
  ...
  handleAll(e) {
    ...
    const n = e.event, s = typeof e.request == "string" ? new Request(e.request) : e.request, r = "params" in e ? e.params : void 0, a = new ea(this, { event: n, request: s, params: r }), i = this._getResponse(a, s, n), o = this._awaitComplete(i, a, s, n);
    return [i, o];
  }
...
class E extends ta {
   ...
   */
  constructor(e = {}) {
    e.cacheName = Ne.getPrecacheName(e.cacheName), super(e), this._fallbackToNetwork = e.fallbackToNetwork !== !1, this.plugins.push(E.copyRedirectedCacheableResponsesPlugin);
  }
  /**
   * @private
...
E.copyRedirectedCacheableResponsesPlugin = {
  async cacheWillUpdate({ response: t }) {
    return t.redirected ? await zr(t) : t;
  }
};
class na {
  /**
  ...
  constructor({ cacheName: e, plugins: n = [], fallbackToNetwork: s = !0 } = {}) {
    this._urlsToCacheKeys = /* @__PURE__ */ new Map(), this._urlsToCacheModes = /* @__PURE__ */ new Map(), this._cacheKeysToIntegrities = /* @__PURE__ */ new Map(), this._strategy = new E({
      cacheName: Ne.getPrecacheName(e),
      plugins: [
        ...n,
        new qr({ precacheController: this })
      ],
      fallbackToNetwork: s
...
let he;
const vt = () => (he || (he = new na()), he);
try {
  self["workbox:routing:7.2.0"] && _();
} catch {
}
const Nt = "GET", q = (t) => t && typeof t == "object" ? t : { handle: t };
class U {
  /**
...
let x;
const aa = () => (x || (x = new ra(), x.addFetchListener(), x.addCacheListener()), x);
function ia(t, e, n) {
  let s;
  if (typeof t == "string") {
...
function* ca(t, { ignoreURLParametersMatching: e = [/^utm_/, /^fbclid$/], directoryIndex: n = "index.html", cleanURLs: s = !0, urlManipulation: r } = {}) {
  const a = new URL(t, location.href);
  a.hash = "", yield a.href;
  const i = oa(a, e);
...
async function Je(t, e) {
  ...
  try {
    await Mt(n), p("[SW] ack ok");
  } catch (s) {
    p("[SW] ack failed, queuing:", s);
    try {
      if (await pa(n), self.registration.sync)
        try {
...
self.addEventListener("push", (t) => {
  t.waitUntil((async () => {
    ...
    })() : {}, n = e.notification ?? {}, s = e.data ?? e ?? {}, r = Date.now(), a = Number(s.serverSentAt || 0);
    p(a ? `[SW] timing: server->SW = ${r - a} ms (serverSentAt=${a}, swNow=${r})` : "[SW] timing: serverSentAt missing");
    const i = n.title ?? s.title ?? "Neue Nachricht", o = n.body ?? s.body ?? "", l = s.url ?? n.click_action ?? "/Mister-X/", c = s.messageId ?? s.id ?? n.tag ?? String(Date.now()), d = s.tag ?? "mrx", m = (await clients.matchAll({ type: "window", includeUncontrolled: !0 })).find((w) => w.visibilityState === "visible"), O = self.navigator && self.navigator.userAgent ? self.navigator.userAgent : "", Y = ma(O);
    if (m) {
      try {
        m.postMessage({ type: "PUSH", payload: s });
      } catch {
      }
      if (Je(c, await Ge()).catch((w) => p("[SW] markDelivered (fg) failed:", w)), Y) {
        const w = `${d}-fg`, Bt = {
          body: o,
          ...
          data: { url: l, messageId: c, tag: w, fg: !0 }
        };
        await self.registration.showNotification(i, Bt), await Pt(w, { tries: 10, intervalMs: 50 }).catch(() => {
    ...
    const Q = `${d}-${c}`, Lt = {
      ...
      timestamp: s.timestamp ?? Date.now(),
      data: { url: l, messageId: c, tag: Q, fg: !1 }
    };
    await self.registration.showNotification(i, Lt), p(`[SW] timing: notification shown at ${Date.now()}`), wa(Q, { tries: 10, intervalMs: 100 }).catch(() => {
    }), X().catch(() => {
    }), Je(c, await Ge()).catch((w) => p("[SW] markDelivered (bg) failed:", w));
  })());
});
...
self.addEventListener("pushsubscriptionchange", (t) => {
  t.waitUntil((async () => {
    try {
      ...
      try {
        await ba("pushSubscriptionChangedAt", Date.now());
      } catch {
      }
    } catch (e) {
