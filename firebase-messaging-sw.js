...
class L extends Error {
  constructor(e, n, s) {
    super(n), this.code = e, this.customData = s, this.name = Wt, Object.setPrototypeOf(this, L.prototype), Error.captureStackTrace && Error.captureStackTrace(this, q.prototype.create);
  }
}
class q {
  constructor(e, n, s) {
  ...
  create(e, ...n) {
    const s = n[0] || {}, r = `${this.service}/${e}`, a = this.errors[e], i = a ? Vt(a, s) : "Error", o = `${this.serviceName}: ${i} (${r}).`;
    return new L(r, o, s);
  }
}
function Vt(t, e) {
...
const et = /* @__PURE__ */ new WeakMap(), he = /* @__PURE__ */ new WeakMap(), tt = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ new WeakMap();
function on(t) {
 ...
 * limitations under the License.
 */
const S = new nn("@firebase/app"), mn = "@firebase/app-compat", wn = "@firebase/analytics-compat", bn = "@firebase/analytics", yn = "@firebase/app-check-compat", _n = "@firebase/app-check", Sn = "@firebase/auth", In = "@firebase/auth-compat", En = "@firebase/database", Cn = "@firebase/data-connect", Tn = "@firebase/database-compat", An = "@firebase/functions", Dn = "@firebase/functions-compat", kn = "@firebase/installations", Rn = "@firebase/installations-compat", vn = "@firebase/messaging", On = "@firebase/messaging-compat", Nn = "@firebase/performance", Mn = "@firebase/performance-compat", Ln = "@firebase/remote-config", Pn = "@firebase/remote-config-compat", Bn = "@firebase/storage", xn = "@firebase/storage-compat", Un = "@firebase/firestore", $n = "@firebase/ai", Fn = "@firebase/firestore-compat", jn = "firebase";
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
async function Jn(t) {
  try {
    const n = (await st()).transaction(U), s = await n.objectStore(U).get(rt(t));
...
async function Be(t, e) {
  try {
    const s = (await st()).transaction(U, "readwrite");
    await s.objectStore(U).put(e, rt(t)), await s.done;
  } catch (n) {
    if (n instanceof L)
      S.warn(n.message);
    else {
...
class Qn {
  ...
  async triggerHeartbeat() {
    var e, n;
    try {
      const r = this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(), a = xe();
      if (((e = this._heartbeatsCache) == null ? void 0 : e.heartbeats) == null && (this._heartbeatsCache = await this._heartbeatsCachePromise, ((n = this._heartbeatsCache) == null ? void 0 : n.heartbeats) == null) || this._heartbeatsCache.lastSentHeartbeatDate === a || this._heartbeatsCache.heartbeats.some((i) => i.date === a))
        return;
      if (this._heartbeatsCache.heartbeats.push({ date: a, agent: r }), this._heartbeatsCache.heartbeats.length > Yn) {
        const i = ts(this._heartbeatsCache.heartbeats);
  ...
  async getHeartbeatsHeader() {
    ...
    try {
      if (this._heartbeatsCache === null && await this._heartbeatsCachePromise, ((e = this._heartbeatsCache) == null ? void 0 : e.heartbeats) == null || this._heartbeatsCache.heartbeats.length === 0)
        return "";
      const n = xe(), { heartbeatsToSend: s, unsentEntries: r } = Zn(this._heartbeatsCache.heartbeats), a = Xe(JSON.stringify({ version: 2, heartbeats: s }));
 ...
 * limitations under the License.
 */
const it = 1e4, ot = `w:${ye}`, ct = "FIS_v2", as = "https://firebaseinstallations.googleapis.com/v1", is = 60 * 60 * 1e3, os = "installations", cs = "Installations";
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
function ut({ projectId: t }) {
  return `${as}/projects/${t}/installations`;
}
function ht(t) {
  return {
    token: t.token,
 ...
 * limitations under the License.
 */
const Ss = "firebase-installations-database", Is = 1, R = "firebase-installations-store";
let se = null;
function _e() {
  return se || (se = z(Ss, Is, {
    upgrade: (t, e) => {
      switch (e) {
        case 0:
...
async function H(t, e) {
  const n = G(t), r = (await _e()).transaction(R, "readwrite"), a = r.objectStore(R), i = await a.get(n);
  return await a.put(e, n), await r.done, (!i || i.fid !== e.fid) && wt(t, e.fid), e;
}
async function yt(t) {
  const e = G(t), s = (await _e()).transaction(R, "readwrite");
  await s.objectStore(R).delete(e), await s.done;
}
async function J(t, e) {
  const n = G(t), r = (await _e()).transaction(R, "readwrite"), a = r.objectStore(R), i = await a.get(n), o = e(i);
...
async function Ts(t, e) {
  try {
    ...
    throw lt(n) && n.customData.serverCode === 409 ? await yt(t.appConfig) : await H(t.appConfig, {
      fid: e.fid,
      registrationStatus: 0
      /* RequestStatus.NOT_STARTED */
    }), n;
...
async function As(t) {
  ...
  for (; e.registrationStatus === 1; )
    await gt(100), e = await $e(t.appConfig);
  if (e.registrationStatus === 0) {
...
async function ks({ appConfig: t, heartbeatServiceProvider: e }, n) {
  const s = Rs(t, n), r = us(t, n), a = e.getImmediate({
    optional: !0
  });
  if (a) {
    const c = await a.getHeartbeatsHeader();
...
async function vs(t, e) {
  ...
  for (; n.authToken.requestStatus === 1; )
    await gt(100), n = await Fe(t.appConfig);
  const s = n.authToken;
 ...
 * limitations under the License.
 */
const It = "installations", Fs = "installations-internal", js = (t) => {
  ...
  const e = t.getProvider("app").getImmediate(), n = be(e, It).getImmediate();
  return {
    getId: () => Bs(n),
    getToken: (r) => xs(n, r)
  };
 ...
 * limitations under the License.
 */
const Et = "BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4", Ws = "https://fcmregistrations.googleapis.com/v1", Ct = "FCM_MSG", Vs = "google.c.a.c_id", qs = 3, zs = 1;
var K;
(function(t) {
 ...
 * limitations under the License.
 */
const ae = "fcm_token_details_db", Js = 5, je = "fcm_token_object_Store";
async function Xs(t) {
  if ("databases" in indexedDB && !(await indexedDB.databases()).map((a) => a.name).includes(ae))
    return null;
  let e = null;
  return (await z(ae, Js, {
    upgrade: async (s, r, a, i) => {
      if (r < 2 || !s.objectStoreNames.contains(je))
        return;
      const o = i.objectStore(je), l = await o.index("fcmSenderId").get(t);
      if (await o.clear(), !!l) {
        if (r === 2) {
          const c = l;
  ...
  })).close(), await ee(ae), await ee("fcm_vapid_details_db"), await ee("undefined"), Ys(e) ? e : null;
}
function Ys(t) {
...
}, p = new q("messaging", "Messaging", tr);
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
async function sr(t, e) {
  const n = await ke(t), s = At(e.subscriptionOptions), r = {
    method: "PATCH",
    headers: n,
    body: JSON.stringify(s)
  };
...
async function ar(t) {
  ...
  if (s) {
    if (cr(s.subscriptionOptions, n))
      return Date.now() >= s.createTime + rr ? ir(t, {
        token: s.token,
        createTime: Date.now(),
...
async function He(t) {
  ...
  e && (await Tt(t.firebaseDependencies, e.token), await er(t.firebaseDependencies));
...
async function yr(t, e) {
  ...
  await He(e), e.vapidKey = ((r = s == null ? void 0 : s.subscriptionOptions) == null ? void 0 : r.vapidKey) ?? Et, await ar(e);
}
...
async function Sr(t) {
  ...
  if (s.host !== r.host)
    return;
  let a = await Cr(s);
  if (a ? a = await a.focus() : (a = await self.clients.openWindow(n), await pr(3e3)), !!a)
...
class Xr {
  ...
  async cachePut(e, n) {
    ...
    if (!a)
      return !1;
    const { cacheName: i, matchOptions: o } = this._strategy, l = await self.caches.open(i), c = this.hasCallback("cacheDidUpdate"), d = c ? await Vr(
...
class Yr {
   ...
   */
  constructor(e = {}) {
    this.cacheName = Re.getRuntimeName(e.cacheName), this.plugins = e.plugins || [], this.fetchOptions = e.fetchOptions, this.matchOptions = e.matchOptions;
  }
  /**
  ...
  handleAll(e) {
    ...
    const n = e.event, s = typeof e.request == "string" ? new Request(e.request) : e.request, r = "params" in e ? e.params : void 0, a = new Xr(this, { event: n, request: s, params: r }), i = this._getResponse(a, s, n), o = this._awaitComplete(i, a, s, n);
    return [i, o];
  }
...
class E extends Yr {
   ...
   */
  constructor(e = {}) {
    e.cacheName = Re.getPrecacheName(e.cacheName), super(e), this._fallbackToNetwork = e.fallbackToNetwork !== !1, this.plugins.push(E.copyRedirectedCacheableResponsesPlugin);
  }
  /**
   * @private
...
class Qr {
  ...
  constructor({ cacheName: e, plugins: n = [], fallbackToNetwork: s = !0 } = {}) {
    this._urlsToCacheKeys = /* @__PURE__ */ new Map(), this._urlsToCacheModes = /* @__PURE__ */ new Map(), this._cacheKeysToIntegrities = /* @__PURE__ */ new Map(), this._strategy = new E({
      cacheName: Re.getPrecacheName(e),
      plugins: [
        ...n,
  ...
  addToCacheList(e) {
    ...
    for (const s of e) {
      ...
      const { cacheKey: r, url: a } = $r(s), i = typeof s != "string" && s.revision ? "reload" : "default";
...
let B;
const ta = () => (B || (B = new ea(), B.addFetchListener(), B.addCacheListener()), B);
function na(t, e, n) {
  let s;
  if (typeof t == "string") {
...
function* ra(t, { ignoreURLParametersMatching: e = [/^utm_/, /^fbclid$/], directoryIndex: n = "index.html", cleanURLs: s = !0, urlManipulation: r } = {}) {
  const a = new URL(t, location.href);
  a.hash = "", yield a.href;
  const i = sa(a, e);
...
async function ua(t) {
  try {
    const e = await $("app-db", "sw-logs"), n = e.transaction("sw-logs", "readwrite"), s = n.objectStore("sw-logs"), r = { msg: t, ts: Date.now() };
    let a = r.ts;
    try {
      s.add(r, a);
    } catch {
...
self.addEventListener("message", (t) => {
  ...
  t.data.type === "GET_SW_LOGS" && (async () => {
    try {
      const n = await $("app-db", "sw-logs"), a = n.transaction("sw-logs", "readonly").objectStore("sw-logs").getAll();
      a.onsuccess = async () => {
        const i = a.result || [];
    ...
    try {
      const n = await $("app-db", "sw-logs"), s = n.transaction("sw-logs", "readwrite");
  ...
  t.waitUntil((async () => {
    ...
    if (d) {
      ...
      if (m) {
        ...
        await self.registration.showNotification(r, Nt), await Ot(g, { tries: 10, intervalMs: 50 }).catch(() => {
        }), await new Promise((Y) => setTimeout(Y, 900)), (await self.registration.getNotifications({ tag: g })).forEach((Y) => Y.close());
      }
      return;
    }
    const I = `${l}-${o}`, X = {
    ...
    await self.registration.showNotification(r, X), fa(I, { tries: 10, intervalMs: 100 }).catch(() => {
    });
    try {
      await ze(o, await qe());
    } catch (g) {
